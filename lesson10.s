...
;
L059C:	lda     _Horiz_scroll_Old
	cmp     _Horiz_scroll
	bcs     L069B
;
; ++Nametable; // if pass 0, switch nametables
;
L06A5:	inc     _Nametable
;
; Nametable &= 1; // keep it 1 or 0
;
L069B:	lda     _Nametable
	and     #$01
	sta     _Nametable
;
