...
;
L062B:	lda     _Horiz_scroll_Old
	cmp     _Horiz_scroll
	bcs     L073F
;
; ++Nametable; // if pass 0, switch nametables
;
L0749:	inc     _Nametable
;
; Nametable &= 1; // keep it 1 or 0
;
L073F:	lda     _Nametable
	and     #$01
	sta     _Nametable
;
